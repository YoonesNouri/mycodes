...
var webAppUrl = "https://script.google.com/macros/s/AKfycbzNJvanxEJlxDVKGkGG7hCKfQlm5_BzDG6Yt3wcozx3PC1vIqMk4s_O8RkECfyZY3KAww/exec";
  ...
  try {
    ...
    if (state === States.Unregistered) {
      ...
      if (isValidUserMobile(messageText)) {
        ...
        sendMessage(userId, "🟡 مطمئن شوید شماره تلفن را درست و ۱۱ رقمی و با پیش شماره 09 وارد کرده اید.");
      }
      ...
      } else { sendMessage(userId, "🟡 مطمئن شوید شماره تلفن را درست و ۱۱ رقمی و با پیش شماره 09 وارد کرده‌اید."); }
...
// when the day in this input format dd / mm / yyyy f.e: 4 / 11 / 1403 is smaller-equal than 12
// the combineAndConvertToISO function converts the solar date and time to ISO Georgian date and time perfectly and precisely,
// but in the cases the day becomes bigger than 12,
// the combineAndConvertToISO returns nothing.