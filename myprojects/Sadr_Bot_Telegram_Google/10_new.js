...
var webAppUrl = "https://script.google.com/macros/s/AKfycbzp9i4ShAgp8NvVwmV106LShjz0WBDR84PZYGNm0AA5AQX3M2lA99RH2wBG02tQyxmKvQ/exec";
...
function authenticateUser(userId) {
  ...
  for (var i = 0; i < data.length; i++) {
    for (var j = 0; j < data[i].length; j++) {
      if (data[i][j].toString() === userId.toString()) {
...
var commandFunctions = {
  ...
  "/Authentication": function (from) {
    ...
    if (userFound) {
      sendMessage(from, "User found: User ID: " + userId);
    } else {
