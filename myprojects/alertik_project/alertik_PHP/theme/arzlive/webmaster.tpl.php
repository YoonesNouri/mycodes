...
<tr><td class="tools">
	<div class="wbox">
		...
		<div class="wrow">عرض جدول به پیکسل</div><div class="winp"><input type="text" id="width_px" value="190" size="7" /></div>
	...
	<div class="wbox">
		<div class="wrow">سایز نوشته تیتر</div><div class="winp"><input type="text" id="font_header" value="11" size="7" /> </div>
	...
	<div class="wbox">
		<div class="wrow">سایز نوشته نام نرخ و یا ردیف زوج</div><div class="winp"><input type="text" class="colors" id="price-title-size" value="11" size="7" /></div>
...
function web_items_checkboxes(){
	...
	foreach ($cur as $key => $name) {
		...
		$out.='<div><label for="3_'.$key.'">'.$name.' آزاد<input type="checkbox" id="3_'.$key.'" value="1" class="exp_currencies" '.(($key==40)?'checked="checked"':'').'></label></div>';
	}
