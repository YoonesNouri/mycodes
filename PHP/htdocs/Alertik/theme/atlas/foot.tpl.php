...
<div class='container'>
    <div class="row footer" id="contactus">
        ...
        <div class="span4 partners_area">
            <div class="partners">سایت های همکار</div>
            <a href="http://www.ezremittance.ca">EZRemittance</a>
        </div>
        ...
        <div class="span4 copyright" style="height:280px; position:relative">
            ...
            <div class="copyright-text">&copy; Copyright 2013 GoldenExchange.<br>All Rights Reserved.</div>
        </div>
    </div>
</div>
