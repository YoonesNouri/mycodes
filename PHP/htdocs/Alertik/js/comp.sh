#!/bin/sh
echo "arzgooya"
cat merge-start.js arzgooya.js merge-end.js>/tmp/tg.js
java -jar ../../tools/external/compiler.jar --charset "utf-8" --compilation_level ADVANCED_OPTIMIZATIONS --externs ../../tools/external/jquery-1.7.js --externs my-extern.js --js_output_file ../service/arzgooya-static.js --js /tmp/tg.js

echo "arzlive"
cat merge-start.js lang.fa.js core.js tg.js arzlive.js tooltip.js merge-end.js>/tmp/tg.js
java -jar ../../tools/external/compiler.jar --charset "utf-8" --compilation_level ADVANCED_OPTIMIZATIONS --externs ../../tools/external/jquery-1.7.js --externs my-extern.js --js_output_file ../public-arzlive/s/s.js --js /tmp/tg.js
cat sparkline.js >> ../public-arzlive/s/s.js
...
echo "Webmaster Exclusive"
cat webmaster-exclusive.js>/tmp/tg.js
java -jar ../../tools/external/compiler.jar --charset "utf-8" --compilation_level ADVANCED_OPTIMIZATIONS --externs ../../tools/external/jquery-1.7.js --externs my-extern.js --js_output_file ../public/static/web-exclusive.js --js /tmp/tg.js

echo "Webmaster"
cat webmaster.js>/tmp/tg.js
java -jar ../../tools/external/compiler.jar --charset "utf-8" --compilation_level ADVANCED_OPTIMIZATIONS --externs ../../tools/external/jquery-1.7.js --externs my-extern.js --js_output_file ../public/static/webmaster.js --js /tmp/tg.js

echo "arzlive Various"
cat merge-start.js arzlive-va.js merge-end.js>/tmp/mazanex-various.js
java -jar ../../tools/external/compiler.jar --charset "utf-8" --compilation_level ADVANCED_OPTIMIZATIONS --externs ../../tools/external/jquery-1.7.js --externs my-extern.js --js_output_file ../public-arzlive/s/va.js --js /tmp/mazanex-various.js
